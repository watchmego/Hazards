...
public class AddProject extends FragmentActivity {
    ...
    private static String hazardId;
        ...
        switch (requestCode) {
            case REQUEST_CODE_ASK_PERMISSIONS:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    // Permission Denied
                    Toast.makeText(AddProject.this, "WRITE_CONTACTS Denied", Toast.LENGTH_SHORT)
                            .show();
                }
                break;
            default:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_project_view);
        ...
        // final String[] mJobArray = intent.getStringArrayExtra("result");

        newDB.queryDB(GUID, "PROJECTS", hazardId);
        mJobArray = newDB.result;
      //  Log.e(TAG, "return to Project" + mJobArray[0][1]);
        ...
        if (findViewById(R.id.fragment_container) != null) {
            ...
            hazardCount = newDB.getCount(GUID, "HAZARDS");
            ...
            if (mJobArray.length != 0) {
                Log.e(TAG, "resultasdfjkl" + mJobArray[0][0]);
                mEmailAddressField.setText(mJobArray[0][1]);
                mSiteNameField.setText(mJobArray[0][2]);
                mContractorsNameField.setText(mJobArray[0][3]);
                mSiteAddressField.setText(mJobArray[0][4]);
                mContractorCompanyField.setText(mJobArray[0][5]);
                mProjectIdField.setText(mJobArray[0][6]);
                mWorkTypeField.setText(mJobArray[0][7]);
                }
            ...
            if (addHazard != null) {
                addHazard.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Log.e(TAG, "personname" + mContractorsNameField);
                        Log.e(TAG, "AddHazard_initialise_GUID =" + GUID);
                        String emailAddressField = mEmailAddressField.getText().toString() + " ";
                        String siteNameField = mSiteNameField.getText().toString() + " ";
                        String contractorsNameField = mContractorsNameField.getText().toString() + " ";
                        String siteAddressField = mSiteAddressField.getText().toString() + " ";
                        ...
                        Log.e(TAG, "click add hazard count = " + newDB.count);
                        if (newDB.count == 0) {
                            newDB.insertProject(mJobArray);
                        }
                        else {newDB.updateProject(mJobArray, GUID);
                        }
                        Log.e(TAG, "pass_array");
                        startHazard(GUID, mJobArray, hazardCount);
    ...
    private void startHazard(String GUID, String[] mJobArray, int hazardCount) {
        Intent intent = new Intent(this, AddHazard.class);
        intent.putExtra("GUID", GUID);
        intent.putExtra("hazardCount", hazardCount);
